      ...
      >
        ...
        <form noValidate onSubmit={formik.handleSubmit}>
          <Stack>
            ...
            <FormikTextField name="email" label="" variant="standard" formik={formik} />
            <TextArea>パスワード</TextArea>
            <FormikTextField name="password" label="" variant="standard" type="password" formik={formik} />
            <Button
              variant="contained"
              type="submit"
              sx={{
            ...
            <Typography sx={{ textAlign: "center", fontSize: "15px", fontWeight: "bold" }}>
